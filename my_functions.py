...
def new_device_login(**kwargs):
    for k,v in kwargs.items():
        print(f"the keyword argument {k} has been passed to this function with value {v}")
...
if __name__ == "__main__":
    ...
    device_login(hostname="1.1.1.1", username="szagh")  # default platform value is cisco
    
    better_adder(10,20,30,40,50,60,70)
    new_device_login(user="szagh", passwd=12345, hostname="192.168.1.1", ssh_enabled=True)
